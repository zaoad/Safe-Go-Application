...
public class PickSourcelocation extends AppCompatActivity implements OnMapReadyCallback, LocationListener, GoogleMap.OnMarkerDragListener {
    Button selectBtn;
        ...
        selectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(lat!=0.0 && longi!=0.0)
                {
                    ...
                    sharedPrefHelper.saveDataToSharedPref(Constants.SOURCE_LATITUDE, lat+"");
                    sharedPrefHelper.saveDataToSharedPref(Constants.SOURCE_LONGITUDE, longi+"");
